...
class HealthResources(BaseResource):
    ...
    def register(self, mcp_instance) -> None:
        ...
        @mcp_instance.resource("argorollout://health/summary")
            ...
            try:
                ...
                for rollout in rollout_list:
                    ...
                    try:
                        ...
                        # get_rollout_status returns flat structure with phase, replicas at top level
                        phase = status_data.get('phase', 'Unknown')
                        
                        # replicas is a dict: {total, updated, ready, available}
                        ...
                        if isinstance(replicas_info, dict):
                            ...
                            replicas_available = replicas_info.get('available', 0)
                        else:
        ...
        @mcp_instance.resource("argorollout://health/{namespace}/{name}/details")
        async def deployment_health_details(namespace: str, name: str) -> str:
            """Get detailed health information for a specific deployment.
            
            Args:
                uri: Resource URI in format argorollout://health/{namespace}/{name}/details
            ...
            try:
                ...
                if isinstance(replicas_info, dict):
                    ...
                    replicas_ready = replicas_info.get('ready', 0)
                    replicas_available = replicas_info.get('available', 0)
                    replicas_updated = replicas_info.get('updated', 0)
                else:
                    replicas_desired = replicas_info if isinstance(replicas_info, int) else 0
                    replicas_ready = 0
                    replicas_available = 0
                ...
                resource_data = {
                    ...
                    "aborted": status_data.get('abort', False)
                }
